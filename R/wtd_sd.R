...
#' @name weighted_sd
#' @description \code{weighted_sd()}, \code{weighted_se()}, \code{weighted_mean()} and \code{weighted_median()}
...
#'   hypothesis.
#'
#' @param x (Numeric) vector or a data frame. For \code{survey_median()},
